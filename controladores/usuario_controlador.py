...
usuario_schema = UsuarioSchema()            # Para traer un usuario
usuarios_schema = UsuarioSchema(many=True)  # Para traer múltiples usuarios
...
def update_usuario(id):
    ...
    usuario.is_admin = request.json.get('is_admin', usuario.is_admin)
    db.session.commit()
    return usuario_schema.jsonify(usuario)
